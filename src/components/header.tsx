  ...
  return (
    <header
      className={`z-50 md:sticky md:top-4 text-white flex justify-center ${
        scrolled
          ? "bg-slate-300 text-black transition-all duration-500"
        ...
        <ul className="flex space-x-4">
          <li>
            <Link
              ...
              className="text-lg font-semibold hover:text-slate-500 relative"
              onMouseEnter={() => setHoveredLink("home")}
              onMouseLeave={() => setHoveredLink(null)}
            >
              Home
              <span
                className={`absolute bottom-0 left-0 w-full h-0.5 bg-slate-500 ${
